...
public class Gerenciador : Questao
{
    ...
    public void CriarQuestoes(Label labelPergunta, Button BotaoResposta1, Button BotaoResposta2, Button BotaoResposta3, Button BotaoResposta4, Button BotaoResposta5)
    {
        var w1 = new Questao();
        w1.NivelResposta = 3;
        ...
        var w6 = new Questao();
        w6.NivelResposta = 7;
        w6.Perguntas = "Em que ano foi criado a torre de Paris";
        w6.Resposta1 = "1888";
        w6.Resposta2 = "1887";
        w6.Resposta3 = "1857";
        w6.Resposta4 = "1950";
    ...
    public async void VerificaCerta(int certa)
    {
        ...
        {
            await App.Current.MainPage.DisplayAlert("Si fudeu", "otario", "OK");
            Initialize();
        }
    }
